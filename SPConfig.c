...
//TODO: fix a situation when there is no value after the parameter and the equal
//also when there is no equal after - need to fix
...
bool spConfigIsExtractionMode(const SPConfig config, SP_CONFIG_MSG* msg){
	...
	if (config->spExtractionMode == true || config->spExtractionMode == false){ //TODO you don't need the if statement.
